...
train=Data[:,7:18] #Get training sets: ['pt','eta','DL1rT_pu_1', 'DL1rT_pc_1', 'DL1rT_pb_1','DL1rT_pu_2', 'DL1rT_pc_2', 'DL1rT_pb_2','DL1rT_pu_3', 'DL1rT_pc_3', 'DL1rT_pb_3']
meanFile=h5py.File("meanstd.h5","r") #Get scale value
mean_vector=meanFile.get("mean")
std_vector=meanFile.get("std")
#The first 11 values are for scaling ['pt','eta','DL1rT_pu_1', 'DL1rT_pc_1', 'DL1rT_pb_1','DL1rT_pu_2', 'DL1rT_pc_2', 'DL1rT_pb_2','DL1rT_pu_3', 'DL1rT_pc_3', 'DL1rT_pb_3'] 
#In this step, the NAN is still NAN.
#Scaling samples
train=(train-mean_vector[:,0:11])/std_vector[:,0:11] 
train=np.nan_to_num(train) #convert the NAN to 0.
#Prepare the inputs
