...
train_data2=train[:,25:28]
'''
fatjet=np.array(train_data1,dtype=[('pt','f8'),('eta','f8')])
subjet0=np.array(train_data2[:,0:1],dtype=[('binned_dl1r_1','f8')])
subjet1=np.array(train_data2[:,1:2],dtype=[('binned_dl1r_2','f8')]) 
subjet2=np.array(train_data2[:,2:3],dtype=[('binned_dl1r_3','f8')]) 
'''
fatjet=train_data1
subjet0=train_data2[:,0:1]
subjet1=train_data2[:,1:2]
subjet2=train_data2[:,2:3]

#print fatjet,fatjet['pt'],fatjet.dtype
...
valid_data2=valid[:,25:28]
'''
fatjetV=np.array(valid_data1,dtype=[('pt','f8'),('eta','f8')])
subjet0V=np.array(valid_data2[:,0:1],dtype=[('binned_dl1r_1','f8')])
subjet1V=np.array(valid_data2[:,1:2],dtype=[('binned_dl1r_2','f8')])
subjet2V=np.array(valid_data2[:,2:3],dtype=[('binned_dl1r_3','f8')])
'''
fatjetV=valid_data1     
subjet0V=valid_data2[:,0:1]
subjet1V=valid_data2[:,1:2]
subjet2V=valid_data2[:,2:3]   
...
def define_model(params):
    ...
    subjet_1_input = Input(shape=(1, ), name='subjet0')
    subjet_2_input = Input(shape=(1, ), name='subjet1')
    subjet_3_input = Input(shape=(1, ), name='subjet2')
...
model_name ="WeiAdmStd_PC_JKDL1r"
save_path = "./"
batchsize=10000
