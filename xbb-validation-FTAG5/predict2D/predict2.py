...
Saved=h5py.File("../Data/Process1D/"+outname, 'r')
dataset1D=Saved.get("data")
dataset1D2D=np.hstack((dataset1D,predictions_JKDL1r))
print(dataset1D2D.shape)

Save=h5py.File("../Data/Process1D2D/"+outname, 'w')
Save.create_dataset("data",data=dataset1D2D)
