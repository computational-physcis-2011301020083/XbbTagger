...
filepathDijets="/global/project/projectdirs/atlas/massDecorrelatedXbb/Xbb0202/DataVRGhost/FlattenData/MergedDijets.h5"
filepathHiggs="/global/project/projectdirs/atlas/massDecorrelatedXbb/Xbb0202/DataVRGhost/FlattenData/MergedHbb.h5"
filepathTop="/global/project/projectdirs/atlas/massDecorrelatedXbb/Xbb0202/DataVRGhost/FlattenData/MergedTop.h5"
...
savehbb = h5py.File("/global/project/projectdirs/atlas/massDecorrelatedXbb/Xbb0202/DataVRGhost/FlattenReweighted/MergedHbb.h5", 'w')
savehbb.create_dataset("data",data=finalhbb)
savehbb.close()
finaltop=np.hstack((reweight1,top))
print finaltop.shape
savetop = h5py.File("/global/project/projectdirs/atlas/massDecorrelatedXbb/Xbb0202/DataVRGhost/FlattenReweighted/MergedTop.h5", 'w')
savetop.create_dataset("data",data=finaltop)
savetop.close()
finaldijets=np.hstack((dijetsweight,dijets))
print finaldijets.shape
savedijets=h5py.File("/global/project/projectdirs/atlas/massDecorrelatedXbb/Xbb0202/DataVRGhost/FlattenReweighted/MergedDijets.h5", 'w')
